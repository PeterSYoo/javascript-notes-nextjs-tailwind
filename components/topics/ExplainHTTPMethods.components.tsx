...
import { MountingMD } from './markdown/MountingMD.components';
import { AlgorithmsMD } from './markdown/AlgorithmsMD.components';
import { ExplainHTTPMethodsMD } from './markdown/ExplainHTTPMethodsMD.components';

export const ExplainHTTPMethods = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Explain the HTTP Methods</span>
            </div>
