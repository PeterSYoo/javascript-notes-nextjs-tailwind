...
import { CSSSelectorsAndTheirSpecificityMD } from './markdown/CSSSelectorsAndTheirSpecificityMD.components';

export const CSSSelectorsAndTheirSpecificity = () => {
    ...
    <>
      {isClicked ? (
        ...
        >
          <div className="flex items-center gap-5">
            <MdNotes className="mb-[1.5px]" />
            <span className="text-sm">CSS Selectors and Their Specificity</span>
          </div>
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <CSSSelectorsAndTheirSpecificityMD />
