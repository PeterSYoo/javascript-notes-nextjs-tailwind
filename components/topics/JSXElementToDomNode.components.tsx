...
import { JSXElementToDomNodeMD } from './markdown/JSXElementToDomNodeMD.components';

export const JSXElementToDomNode = () => {
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">
                What happens from JSX element to DOM node?
              </span>
            </div>
