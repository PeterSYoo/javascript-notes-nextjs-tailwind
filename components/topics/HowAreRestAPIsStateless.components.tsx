...
import { HowAreRestAPIsStatelessMD } from './markdown/HowAreRestAPIsStatelessMD.components';

export const HowAreRestAPIsStateless = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">How are REST APIs Stateless?</span>
            </div>
