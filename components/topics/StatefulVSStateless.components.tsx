...
import { CompilationProcessMD } from './markdown/CompilationProcessMD.components';
import { StatefulVSStatelessMD } from './markdown/StatefulVSStatelessMD.components';

export const StatefulVSStateless = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Stateful vs. Stateless</span>
            </div>
