...
import { FunctionalProgrammingMD } from './markdown/FunctionalProgrammingMD.components';
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Functional Programming</span>
            </div>
