...
import { HowDoBrowserEnginesHandleExecutionMD } from './markdown/HowDoBrowserEnginesHandleExecutionMD.components';

export const HowDoBrowserEnginesHandleExecution = () => {
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">
                How do Browser Engines Handle the Execution of a web app?
              </span>
            </div>
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <HowDoBrowserEnginesHandleExecutionMD />
