...
import { ServiceOrientedArchitectureMD } from './markdown/ServiceOrientedArchitectureMD.components';

export const ServiceOrientedArchitecture = () => {
    ...
    <>
      {isClicked ? (
        ...
        >
          <div className="flex items-center gap-5">
            <MdNotes className="mb-[1.5px]" />
            <span className="text-sm">Service-Oriented Architecture (SOA)</span>
          </div>
