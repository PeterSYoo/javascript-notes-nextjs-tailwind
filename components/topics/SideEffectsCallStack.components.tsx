...
import { SideEffectsCallStackMD } from './markdown/SideEffectsCallStackMD.components';

export const SideEffectsCallStack = () => {
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">
                Is Anything That Isn&apos;t Directly Sent to the Call Stack, but
                is Handled Elsewhere Considered a Side Effect?
              </span>
            </div>
