...
import { WhatCausesRerendersMD } from './markdown/WhatCausesRerendersMD.components';

export const WhatCausesRerenders = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">What Causes a Re-render?</span>
            </div>
