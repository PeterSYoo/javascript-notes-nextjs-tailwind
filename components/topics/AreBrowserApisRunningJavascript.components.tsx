...
import { AreBrowserApisRunningJavascriptMD } from './markdown/AreBrowserApisRunningJavascriptMD.components';

export const AreBrowserApisRunningJavascript = () => {
      ...
      {isClicked ? (
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">
                Are Browser API&apos;s running JavaScript when they are
        ...
        >
          <div className="flex items-center gap-5">
            <MdNotes className="mb-[1.5px]" />
            <span className="text-sm">
              Are Browser API&apos;s running JavaScript when they are executing
              asynchronous tasks?
            </span>
          </div>
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <AreBrowserApisRunningJavascriptMD />
