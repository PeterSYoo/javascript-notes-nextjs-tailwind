...
import { SetStateWithNewObjectMD } from './markdown/SetStateWithNewObjectMD.components';

export const SetStateWithNewObject = () => {
    ...
    <>
      {isClicked ? (
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">
                How to Set State With a new Object
              </span>
            </div>
        ...
        >
          <div className="flex items-center gap-5">
            <MdNotes className="mb-[1.5px]" />
            <span className="text-sm">How to Set State With a new Object</span>
          </div>
