...
import { EventDrivenProgrammingMD } from './markdown/EventDrivenProgrammingMD.components';

export const EventDrivenProgramming = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Event-driven Programming</span>
            </div>
