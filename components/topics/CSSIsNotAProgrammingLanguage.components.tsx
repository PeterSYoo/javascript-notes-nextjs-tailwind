...
import { CSSIsNotConsideredAProgrammingLanguageMD } from './markdown/CSSIsNotConsideredAProgrammingLanguageMD.components';

export const CSSIsNotConsideredAProgrammingLanguage = () => {
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <CSSIsNotConsideredAProgrammingLanguageMD />
