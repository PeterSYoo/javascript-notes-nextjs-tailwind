...
import { MonolithicArchitectureMD } from './markdown/MonolithicArchitectureMD.components';

export const MonolithicArchitecture = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Monolithic Architecture</span>
            </div>
