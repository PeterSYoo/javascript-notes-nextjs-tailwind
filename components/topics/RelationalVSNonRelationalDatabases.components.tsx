...
import { RelationalVSNonRelationalDatabasesMD } from './markdown/RelationalVSNonRelationalDatabasesMD.components';

export const RelationalVSNonRelationalDatabases = () => {
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <RelationalVSNonRelationalDatabasesMD />
