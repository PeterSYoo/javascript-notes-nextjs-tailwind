...
import { WhatIsACleanUpFunctionMD } from './markdown/WhatIsACleanUpFunctionMD.components';

export const WhatIsACleanUpFunction = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">What is a Cleanup Function?</span>
            </div>
