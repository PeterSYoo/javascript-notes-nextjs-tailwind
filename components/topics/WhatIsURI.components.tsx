...
import { ExplainHTTPCodesMD } from './markdown/ExplainHTTPCodesMD.components';
import { WhatIsURIMD } from './markdown/WhatIsURIMD.components';

export const WhatIsURI = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">What is a URI?</span>
            </div>
