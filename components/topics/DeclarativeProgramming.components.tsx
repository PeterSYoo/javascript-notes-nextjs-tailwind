...
import { DeclarativeProgrammingMD } from './markdown/DeclarativeProgrammingMD.components';

export const DeclarativeProgramming = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Declarative Programming</span>
            </div>
