...
import { WorkingWithComplexDataUseStateMD } from './markdown/WorkingWithComplexDataUseStateMD.components';

export const WorkingWithComplexDataUseState = () => {
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <WorkingWithComplexDataUseStateMD />
