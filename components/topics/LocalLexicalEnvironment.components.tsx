...
import { LocalLexicalEnvironmentMD } from './markdown/LocalLexicalEnvironmentMD.components';

export const LocalLexicalEnvironment = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Local Lexical Environment</span>
            </div>
