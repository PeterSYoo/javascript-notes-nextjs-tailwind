...
import { WhenToChooseUseReducerVSUseStateMD } from './markdown/WhenToChooseUseReducerVSUseStateMD.components';

export const WhenToChooseUseReducerVSUseState = () => {
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <WhenToChooseUseReducerVSUseStateMD />
