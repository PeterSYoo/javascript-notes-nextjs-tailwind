...
import { NoSQLDatabaseRelationshipsMD } from './markdown/NoSQLDatabaseRelationshipsMD.components';

export const NoSQLDatabaseRelationships = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">NoSQL Database Relationships</span>
            </div>
