...
import { SQLDatabaseRelationshipsMD } from './markdown/SQLDatabaseRelationshipsMD.components';

export const SQLDatabaseRelationships = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">SQL Database Relationships</span>
            </div>
