...
import { ControlledVSUncontrolledComponentsMD } from './markdown/ControlledVSUncontrolledComponentsMD.components';

export const ControlledVSUncontrolledComponents = () => {
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <ControlledVSUncontrolledComponentsMD />
