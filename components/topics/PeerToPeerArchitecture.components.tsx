...
import { PeerToPeerArchitectureMD } from './markdown/PeerToPeerArchitectureMD.components';

export const PeerToPeerArchitecture = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Peer-to-Peer Architecture</span>
            </div>
