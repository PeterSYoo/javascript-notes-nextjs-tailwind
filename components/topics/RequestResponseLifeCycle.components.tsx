...
import { RequestResponseLifeCycleMD } from './markdown/RequestResponseLifeCycleMD.components';

export const RequestResponseLifeCycle = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Request/Response Life Cycle</span>
            </div>
