...
import { ClientServerArchitectureMD } from './markdown/ClientServerArchitectureMD.components';

export const ClientServerArchitecture = () => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm">Client-Server Architecture</span>
            </div>
