...
import { BestPracticeURIRESTfulServicesMD } from './markdown/BestPracticeURIRESTfulServicesMD.components';

export const BestPracticeURIRESTfulServices = () => {
      ...
      {isClicked ? (
        <>
          <div className="markdown-container flex flex-col gap-4 text-[16px]">
            <BestPracticeURIRESTfulServicesMD />
